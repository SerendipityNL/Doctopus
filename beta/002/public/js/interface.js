jQuery(document).ready( function() {
	...
	jQuery('#newDocumentModal .modal-footer .btn-success').on('click', function() {
		...
		newDocument.title 		= jQuery('#newDocumentModal .modal-body input[name="documentDescription"]').val();
