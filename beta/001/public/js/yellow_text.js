	...
	var methods = {
		...
		*/
		createTextEditor: function() {
			...
			var iFrameCSS = '<style type="text/css">body{padding:2%; font-family:inherit;}p{margin:0;}</style>';
		...
		*/		
		events: function() {
			...
			$( methods.editor ).contents().find("body").on("focus", function(e){
		...
		*/        
		...
		removeHTML: function(){
			$(methods.editor).contents().find("body").html( $(methods.editor).contents().find("body").text() );
		},
